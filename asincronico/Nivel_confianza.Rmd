...
>*¿Cómo puede afectar el rango de valores del intervalo de confianza?*
...
Si desea ver la aplicación Web en un tamaño mayor visite el siguiente enlace: 
...
4. Con los parámetros definidos en 3, responda. ¿Qué paso con el tamaño de los intervalos cuando aumentó el tamaño de muestra de 30 a 100? (Nota, al cambiar $N$ se toma una nueva muestra, por eso puede observar cambios bruscos).
